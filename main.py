...
if user_input:
    ...
    if "퀴즈" in user_input:
        ...
        prompt = f"""
            너는 각종 범죄(보이스피싱, 도용, 취업사기 등)에 예방을 위한 도움을 제공하는 AI야. 사용자에게 범죄 예방과 관련된 퀴즈를 출제하고,
            다양한 범죄 상황에 대한 간단한 문제를 제공해줌으로써 사용자가 답을 말하면 그 답이 맞았는지 틀렸는지 평가하고 해설을 제공해 줄 수 있어야해.
            ...
            이런식으로 새로운 상황과 3개의 선택지를 제시해줘. 그리고 사용자가 답변을 제출하면 정답을 알려주고 해설을 제공해줘.
            """
